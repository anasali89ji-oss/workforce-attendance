  ...
  return (
    <div className="page anim-fade-up page-sm">
      <div style={{ marginBottom:28 }}>
        ...
        <p style={{ color:'var(--text-3)', fontSize:13, marginTop:3 }}>Manage your personal information</p>
      </div>
      ...
      <div className="tabs-underline" style={{ marginBottom:20 }}>
        {([['info','Personal Info',User],['password','Password',Lock]] as const).map(([id,label,Icon]) => (
      ...
      {tab === 'password' && (
        <div className="card" style={{ padding:'20px 22px' }}>
          <div style={{ display:'flex', flexDirection:'column', gap:14, maxWidth:380 }}>
            {([['Current Password','current'],['New Password','newPw'],['Confirm Password','confirm']] as const).map(([label,key]) => (
