  ...
  return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'var(--bg)',padding:24}}>
      <div style={{textAlign:'center',maxWidth:400}}>
        ...
        <p style={{color:'var(--text-3)',fontSize:14,marginBottom:28,lineHeight:1.6}}>This page does not exist or you do not have access. Check the URL or return to your dashboard.</p>
